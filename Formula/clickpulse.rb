...
class Clickpulse < Formula
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/ppiankov/clickpulse/releases/download/v0.2.10/clickpulse_0.2.10_linux_amd64.tar.gz"
      sha256 "4223dedb39d410468c853b7895fc7f4d644261e0817e268195926afbf58096b3"
      define_method(:install) do
        bin.install "clickpulse"
      end
    end
