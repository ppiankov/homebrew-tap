...
class Clickpulse < Formula
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/ppiankov/clickpulse/releases/download/v0.2.8/clickpulse_0.2.8_linux_amd64.tar.gz"
      sha256 "6280b4d8da7e80291b4e24ffbb1e8a5fe0c050fc7124d280dcdc009aceb65f06"
      define_method(:install) do
        bin.install "clickpulse"
      end
    end
