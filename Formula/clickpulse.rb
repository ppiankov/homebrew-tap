...
class Clickpulse < Formula
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/ppiankov/clickpulse/releases/download/v0.2.7/clickpulse_0.2.7_linux_amd64.tar.gz"
      sha256 "a4d71be9b3c18cf71b2f1c01380f9c57005def375fe4eec3b48c397a0a909312"
      define_method(:install) do
        bin.install "clickpulse"
      end
    end
