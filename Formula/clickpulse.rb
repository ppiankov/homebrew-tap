...
class Clickpulse < Formula
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/ppiankov/clickpulse/releases/download/v0.2.5/clickpulse_0.2.5_linux_amd64.tar.gz"
      sha256 "d37818b0c9a24c26071b6b83f10f588d49f47ec7acb7c8cbe74db276472dd2f4"
      define_method(:install) do
        bin.install "clickpulse"
      end
    end
