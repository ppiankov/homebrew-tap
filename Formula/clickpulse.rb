...
class Clickpulse < Formula
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/ppiankov/clickpulse/releases/download/v0.2.6/clickpulse_0.2.6_linux_amd64.tar.gz"
      sha256 "5a4f1751f061db3bfe15e57f19a4ad5d0ea292fb5587304b8c4874627cbcf3af"
      define_method(:install) do
        bin.install "clickpulse"
      end
    end
